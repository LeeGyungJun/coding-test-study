...
namespace Ct
{
    class Program
    {
        ...
        static string PalindromMake(string[] strArr)
        {
            ...
            for (int j = 0; j < strArr.Length; j++)
            {
                for (int o = 0; o < strArr.Length; o++)
                {
                    ...
                    string palindromStr = strArr[j] + strArr[o];
                    string reversetStr = new string(palindromStr.Reverse().ToArray());
                    if (palindromStr == reversetStr)
                    {
                        return palindromStr;
                    }
        ...
        static void Main(string[] args)
        {
            ...
            for (int x = 0; x < inputNum; x++)
            {
                ...
                Console.WriteLine(PalindromMake(strArr));
